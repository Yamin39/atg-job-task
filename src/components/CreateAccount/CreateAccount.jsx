...
const CreateAccount = ({ setUser, setIsModalOpen }) => {
      ...
      <div className="px-5 md:px-9 pt-[22px] md:pt-6 mb-[18px] md:pb-9">
        <div className="flex justify-between items-center gap-2 mb-6">
          ...
          <p className="hidden md:block text-[#3D3D3D] text-[13px]">
            Already have an account? <button className="font-semibold text-[#2F6CE5]">Sign In</button>
          </p>
        </div>
          ...
          <div className="md:w-[48.2%]">
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="my-[22px] md:my-0 flex md:block items-center justify-between gap-2">
                ...
                <button className="md:hidden text-[#495057] text-[13px] font-medium leading-[17px] tracking-[0px] text-center underline">or, Sign In</button>
              </div>
            </form>
