...
const JobPost = (props) => {
  ...
  const { category, title, designation, location, authorImg, authorName, views } = props;
  return (
    <div className="border border-[#E0E0E0] rounded">
      <div className="p-4 sm:p-5">
        ...
        <div className="flex flex-col justify-center gap-4 mt-[11px] sm:mt-3 mb-[21px] sm:mb-8">
          <div className="text-[12px] sm:text-[15px] font-medium leading-5 flex items-center gap-12">
            <div>
              <p className="flex items-center gap-1">
                <img src={jobIcon} className="size-5" alt="Job Icon" />
          ...
          <button className="text-[13px] font-semibold leading-[140.4%] text-[#02B875] p-2.5 w-full rounded-lg border border-[#A9AEB8]">
            Apply on Timesjobs
          </button>
        </div>
